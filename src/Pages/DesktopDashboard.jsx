    ...
    <div className="grid grid-cols-2 gap-6 mb-4">
      <div className="bg-[#d7f8df] rounded-[14px] p-4 text-black dark:text-white dark:bg-[#153f25]">
        <div className="mt-1 flex justify-between">
          <p className="dark:text-[#69f0ae] text-[#1e8449] text-[17px] font-semibold mb-1">Income</p>
          <FontAwesomeIcon
            className="text-white dark:text-[#69f0ae] mt-1 bg-[#1e8449] rounded-full p-[2px] font-bold text-[10px]"
            icon={faArrowDown}
          />
        </div>
      ...
      <div className="bg-[#fddede] dark:bg-[#3d1818] rounded-[14px] p-4 text-black dark:text-white">
        <div className="mt-1 flex justify-between">
          <p className="text-[17px] text-[#c0392b] dark:text-[#ff5252] font-semibold mb-1">Expenses</p>
          <FontAwesomeIcon
            className="text-white mt-1 bg-[#c0392b] dark:bg-[#ff5252] rounded-full p-[2px] font-bold text-[10px]"
            icon={faArrowUp}
          />
        </div>
      ...
      <div className="rounded-md mt-3 border-white">
        {transactions.length === 0 ? (
          <p className="p-3 text-gray-500 text-center text-sm">
            No transactions yet. <br /> Create your first transaction
          </p>
        ) : (
          [...transactions]
            ...
            .map((t) => (
              ...
              >
                <div className="flex gap-3 items-center">
                  <div>
                    <p className={`text-gray-800 p-2 rounded-[15px] ${t.type === "income" ? "bg-green-200" : "bg-red-200"}`}>
                      {t.icon}
                    </p>
                  </div>
                  <div>
